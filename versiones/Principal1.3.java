...
public class Principal {
	...
	private static void iniciarPrograma() {
		...
		BigInteger bigRangoMinimo = new BigInteger("9999999999999999999999999999999999900");//y no me muestra el string
		BigInteger bigRangoMaximo = new BigInteger("9999999999999999999999999999999999999");
		int numHilos = 5;
		...
		System.out.println("Número más alto-----------------> "+datos.getInfoNumMasAlto());
		System.out.println("Número que no terminan en 4-2-1-> "+datos.getNumEncontrados());
